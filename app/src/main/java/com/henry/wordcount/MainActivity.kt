...
fun WordCountApp(initialUris: List<Uri>) {
    ...
    /** v1.9.60: 暂停/停止当前统计——取消恢复轮询、停止统计服务（通知随之取消）、清进度、仅保留已统计条目。 */
    ...
    fun stopAndShowComplete() {
        ...
        entries.removeAll { it.result == null && it.rawResult == null && it.error == null }
            ...
            withContext(Dispatchers.IO) {
                ...
                dwgFiles.forEachIndexed { i, cf ->
                    ...
                    try {
                        ...
                        // v1.5.81: 共享 DwgProcessor，确保压缩包内 DWG 与单独打开完全一致
